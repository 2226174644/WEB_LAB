...
public class ProductDaoImp implements ProductDao {
    ...
    public void addProduct(Product product) throws SQLException {
        String sql = "insert into web_201800301278_products values(null,?,?,?,?,?,?,?)";
    ...
    public List<Product> findAll() throws SQLException {
        String sql = "select * from  web_201800301278_products ";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public Product findById(int id) throws SQLException {
        String sql = "select * from  web_201800301278_products where id=?";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public void update(Product p) throws SQLException {
        String sql = "update  web_201800301278_products set name=?,price=?,pnum=?,c3code=?,"
    ...
    public List<Product> simpleSelect(String field, String msg) throws SQLException {
        String sql = "select * from  web_201800301278_products where " + field + " like ?";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public List<Product> findByPage(int pageNum, int currentPage) throws SQLException {
        String sql = "select * from  web_201800301278_products limit ?,?";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
        return runner.query(sql, new BeanListHandler<Product>(Product.class),
    ...
    public int findAllCount() throws SQLException {
        String sql = "select count(*) from  web_201800301278_products";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public int findCountByCode(String code) throws SQLException {
        String sql = "select count(*) from  web_201800301278_products where substring(c3code,1,"+code.length()+")"+"=?";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public int delById(int id) throws SQLException {
        String sql = "delete from  web_201800301278_products where id=?";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public List<Product> findByCode(String code) throws SQLException {
        String sql = "select * from web_201800301278_products where substring(c3code,1,"+code.length()+")"+"=?";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
    ...
    public List<Product> findByPageByCode(int pageNum, int currentPage, String code) throws SQLException {
        String sql = "select * from web_201800301278_products where substring(c3code,1,"+code.length()+")"+"=? limit ?,?";
        QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
        return runner.query(sql, new BeanListHandler<Product>(Product.class), code,
                (pageNum - 1) * currentPage, currentPage);
    }
