...
function findProductById(id){
	location.href="http://localhost:8080/ZY2018003012783/ProductFindByIdServlet?id="+id;
};
function phone(obj) {
	location.href="${pageContext.request.contextPath}/FindCategoryServlet?name="+encodeURIComponent(encodeURIComponent(obj));
}
function tocart() {
	location.href="http://localhost:8080/ZY2018003012783/showcart.jsp";
}
</script>
</head>
<body>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="home/img/22d94f6e50d98f6f68308814ff9795e21.jpg" alt="..." onclick="phone('手机')">
...
<aside class="aside-tool">
    <ul>
        <li class="customer">
            <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2226174644&site=qq&menu=yes">联系客服</a>
        </li>
        <li class="top"></li>
    </ul>
</aside>
<footer>
   <div style="margin: 0 auto;">
        <h3 style="align-content: center;">E购物网站</h3>
    </div>
</footer>
